...
{
    public class CaseEmergencyContactLogic : CaseChildBaseLogic<CaseEmergencyContact>
    {
        public CaseEmergencyContactLogic(DataContext db) : base(db)
        {
        }

        public async override Task Update(int id, int caseId, int organizationId, int userId, CaseEmergencyContact item)
        {
            var result = await (from v in db.CaseEmergencyContact
